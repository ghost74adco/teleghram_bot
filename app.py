...
def ensure_valid_json_files():
    """
    Garantit que products.json et orders.json sont valides au démarrage.
    Crée ou répare automatiquement les fichiers corrompus.
    """
...
# Vérifier les fichiers JSON au démarrage
